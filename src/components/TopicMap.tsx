import { curriculum, isTopicUnlocked } from '../data/curriculum';
...
export default function TopicMap({ completedTopics, scores, onSelect, onReset, onBackToHome }: Props) {
  const units = [...new Set(curriculum.map((t) => t.unit))];
  ...
  return (
    <div className="min-h-screen bg-slate-950 p-6">
      ...
      <div className="max-w-3xl mx-auto mb-8">
        <div className="flex items-center justify-between mb-2">
          <div>
            ...
            <h1 className="text-3xl font-bold text-white">Physics Explorer</h1>
      ...
      <div className="max-w-3xl mx-auto space-y-8">
        {units.map((unit) => {
          const topics = curriculum.filter((t) => t.unit === unit);
          ...
          return (
            <div key={unit}>
              ...
              <div className="grid gap-3">
                {topics.map((topic) => {
                  const idx = curriculum.findIndex((t) => t.id === topic.id);
                  const unlocked = isTopicUnlocked(idx, completedTopics);
